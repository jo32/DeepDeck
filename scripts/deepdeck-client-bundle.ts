/**
 * 0.1.5-rc.2-compatible client bundle preset for DeepDeck plugins that live outside
...
/** Build one external DeepDeck plugin using the 0.1.5-rc.2 dynamic-client contract. */
