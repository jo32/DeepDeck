...
const localeMetadata = {
  zh: {
    ...
    description: "DeepDeck 是开源的 DeepSeek Harness 桌面客户端，支持可安装 App 与 AI 辅助构建。了解 Browser + WebMCP 开发预览：每个网站一个 Agent，让页面操作成为可复用工具。",
  ...
  en: {
    ...
    description: "DeepDeck is an open-source DeepSeek Harness desktop client with installable Apps. Explore the Browser + WebMCP preview: a dedicated Agent and reusable tools for your websites.",
